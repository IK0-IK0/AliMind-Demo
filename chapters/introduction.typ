...
The Theory of Planned Behavior (TPB) is one of the most extensively tested frameworks for predicting health behavior @ajzen1991theory. The theory identifies three key psychological factors that determine whether someone will act on their intentions: their attitude toward the behavior, perceived social pressure (subjective norm), and their confidence in their ability to perform the behavior (perceived behavioral control). Meta-analytic evidence shows that TPB accounts for 39% of the variance in intention and 27% of the variance in behavior across health-related actions @armitage2001EfficacyOT.
...
The Transtheoretical Model (TTM) addresses this gap by conceptualizing behavior change as a process that unfolds through distinct stages: pre-contemplation (not considering change), contemplation (thinking about change), preparation (planning to act), action (actively changing), and maintenance (sustaining change) @prochaska1997transtheoretical. Systematic reviews confirm that stage-matched interventions improve dietary outcomes across diverse populations @spencer2007stage.
